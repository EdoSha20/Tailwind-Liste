<script>
  import besique from '$lib/assets/besique.jpg';
  import dana from '$lib/assets/dana.jpg';
  import elvis from '$lib/assets/elvis.jpg';
  import james from '$lib/assets/james.jpg';
</script>
